...
from .payment_finder_controller import PaymentFinderController


class MockPaymentRepository:
    def get_transaction_by_id(self, transaction_id: int):
        return Payment(date=date(2024, 11, 9).isoformat(),
                       id=transaction_id,
                       account_id=456,
...
def test_find_transaction():
    controller = PaymentFinderController(MockPaymentRepository())
    transaction_id = 123
