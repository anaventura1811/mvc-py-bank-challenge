...
class PaymentListController(TransactionListControllerInterface):
    ...
    def __list_transactions_in_db(self, account_id: int) -> List[Payment]:
        transactions = self.__payment_repository.list_transactions(account_id)
        return transactions

    def __format_response(self, transactions: List[Payment]) -> Dict:
