...
class TransactionListController(TransactionListControllerInterface):
    def __init__(self, transaction_repository: TransactionInterface) -> None:
    ...
    def __list_transactions_in_db(self, account_id: int) -> List[TransactionTable]:
        transactions = self.__transaction_repository.list_transactions(account_id)
        return transactions

    def __format_response(self, transactions: List[TransactionTable]) -> Dict:
