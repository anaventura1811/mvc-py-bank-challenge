...
class PaymentCreatorController(TransactionCreatorControllerInterface):
    def __init__(self,
                 payment_repository: TransactionInterface,
    ...
    def create(self, transaction: Dict) -> Dict:
        self.__validate_payment(transaction)
        ...
        formatted_payment = self.__generate_transaction_from_dict(
    ...
    def __validate_payment(self, transaction: Dict) -> None:
    ...
    def __generate_transaction_from_dict(
            self, payload: Dict, current_balance: float, transaction_limit: float) -> Payment:
    ...
    def __insert_transaction_in_db(self, transaction: Payment) -> None:
        self.__payment_repository.create_transaction(transaction)
