...
from .deposit_finder_controller import DepositFinderController


class MockDepositRepository:
    def get_transaction_by_id(self, transaction_id: int):
        return Deposit(date=date(2024, 11, 9).isoformat(),
                       id=transaction_id,
                       account_id=456,
...
def test_find_transaction():
    controller = DepositFinderController(MockDepositRepository())
    transaction_id = 123
